...
public class escapeRouteManager : MonoBehaviour
{
    ...
    void InitializeTargetPointList()
    {
        targetPointList = new Vector3[,]
        {
            ...
            {new Vector3(-7.967577f,0.06f,-4.28f),new Vector3(-10.65f,0.06f,-4.28f),new Vector3(-10.65f, 0.06f, Random.Range(-1.7f, 1.7f))},
            {new Vector3(-0.89f,0.06f,-4.28f),new Vector3(-3.57f,0.06f,-4.28f),new Vector3(-3.57f,0.06f, Random.Range(-1.7f, 1.7f))}
        };
    }
